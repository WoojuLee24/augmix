...
class Trainer():
    ...
    def train(self, train_loader, args, optimizer, scheduler):
        ...
        for i, (images, targets) in enumerate(train_loader):
            ...
            if args.no_jsd or args.aug == 'none':
                ...
                # # normalization (temporary code)
                # logits_all = F.normalize(logits_all, dim=1)
    ...
    # def train1_1(self, train_loader, args, optimizer, scheduler):
    #     """Train for one epoch."""
    #     self.net.train()
    #     wandb_features = {}
    #     total_ce_loss = 0.
    ...
    #             additional_loss = get_additional_loss(args.additional_loss, features_clean, features_aug1, features_aug2,
    #                                                   12, targets, args.temper)
    #             for key, feature in self.net.module.hook_features.items():
    #                 feature_clean, feature_aug1, feature_aug2 = torch.split(feature[0], images[0].size(0))
    #                 k = get_additional_loss(args.additional_loss, feature_clean, feature_aug1, feature_aug2,
    ...
    #
    #
    # def train1_2(self, train_loader, args, optimizer, scheduler):
    #     """Train for one epoch."""
    #     self.net.train()
    #     wandb_features = {}
    #     total_ce_loss = 0.
    ...
    #
    #
    # def train3_1(self, train_loader, args, optimizer, scheduler):
    #     """Train for one epoch."""
    #     self.net.train()
    #     wandb_features = {}
    #     total_ce_loss = 0.
